...
const Product3 = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-4 mt-6 bg-[#d3effc] rounded-lg">
      ...
      <div className="mt-8">
        ...
        <div className="mt-14">
          ...
          <div className="mt-5 text-red-800 lg:max-w-[900px] mx-auto flex flex-wrap gap-8 items-center ">
      ...
      <div className="lg:max-w-[900px] mx-auto mt-12">
        ...
        <div>
          <h4 className="text-xl mt-8 lg:max-w-[900px] mx-auto font-semibold">
            Ketoconazole:
          </h4>
          <p className="mt-3 text-slate-600">
        ...
        <div>
          <h4 className="text-xl text-[#eb2ea0] mt-12 lg:max-w-[900px] mx-auto font-semibold">
            Zinc pyrithione:
          </h4>
          <p className="mt-3 text-slate-600">
