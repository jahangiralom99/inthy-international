...
const Card = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-6 mt-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 mt-8 place-content-center justify-items-center gap-6">
        <Link
          to="/product1"
        ...
        <Link
          ...
          className="text-center md:w-96 border rounded-lg p-3 hover:shadow"
        >
          <img className="md:w-72 inline" src={image2} alt="INTHYGLOW FACEWASH" />
